...
Confirmation time is a critical metric for a value transfer network as Qitmeer is. SPECTRE is a super fast confirmation protocol. For most ordinary transacation, SPECTRE can reach robust confirmation in orders of seconds, which can even complete with centralized payment network.
